            ...
            <table className="table">
              <tbody>
                ...
                <tr>
                  ...
                  <td>{fetchedData.origin?.name || "Unknown"}</td>
                </tr>
                <tr>
                  <td>
                    <span className="fw-bold">Location Name:</span>
                  </td>
                  <td>{fetchedData.location?.name || "Unknown"}</td>
                </tr>
                <tr>
                  <td>
                    <span className="fw-bold">Location Type:</span>
                  </td>
                  <td>{locationDetails?.type || "Unknown"}</td>
                </tr>
                <tr>
                  <td>
                    <span className="fw-bold">Location Dimension:</span>
                  </td>
                  <td>{locationDetails?.dimension || "Unknown"}</td>
                </tr>
                <tr>
                  <td>
                    <span className="fw-bold">No of Residents:</span>
                  </td>
                  <td>{locationDetails?.residents?.length || "0"}</td>
                </tr>
                <tr>
                  <td>
                    <span className="fw-bold">No of Episodes featured:</span>
                  </td>
                  <td>{featuredEpisodes?.length}</td>
                </tr>
                <tr>
                  <td>
                    <span className="fw-bold">Name of Episodes featured:</span>
                  </td>
                  <td>
                    {featuredEpisodes.map((episode, index) => (
                      <span key={index}>
                        {episode.name}
                        {index !== featuredEpisodes.length - 1 && ", "}
                      </span>
                    ))}
                  </td>
                </tr>
